...
function EditUserForm() {
  ...
  return (
    ...
    >
      <h2 className="text-3xl md:text-5xl font-light text-white my-6 md:my-10 text-center">
      ...
      <div className="relative mb-6">
        <input
          ...
          className="w-full p-3 bg-black text-white border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500"
        />
        {/* Suggestions dynamiques */}
        {suggestions.length > 0 && (
          <ul className="absolute w-full bg-white text-black shadow-lg rounded-lg mt-2 z-50 max-h-60 overflow-y-auto">
      ...
      <div className="w-full mx-auto bg-white bg-opacity-25 p-4 md:p-10 rounded-lg shadow-lg backdrop-blur-sm">
        ...
        <select
          ...
          className="w-full p-3 bg-black text-white border border-gray-300 rounded-lg shadow-sm mb-5 focus:ring-2 focus:ring-blue-500"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex flex-col space-y-4">
            ...
            <div className="w-full flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
              <input
                ...
                value={formData.nom || ""}
                onChange={handleChange}
                className="w-full md:w-1/2 p-3 bg-black text-white border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500"
              />
              <input
                type="text"
                name="prenom"
          ...
          <div className="flex justify-center mt-6">
            <button
              type="submit"
              className="w-full md:w-1/3 bg-green-500 hover:bg-green-600 text-white p-3 rounded-lg shadow-md transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
            >
              Modifier
            </button>
          </div>
