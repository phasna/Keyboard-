        ...
        <div className="bg-gradient-to-r from-gray-800 via-black to-gray-900 min-h-screen flex flex-col items-center py-8 sm:py-10 lg:py-12 xl:mt-32">
            ...
            <div className="w-full flex flex-col sm:flex-row gap-6 sm:gap-8 p-6">
                ...
                <div className="sm:w-1/2 bg-gray-700 bg-opacity-70 p-6 rounded-lg flex flex-col shadow-lg">
                    <button onClick={handleClearCart} className="w-full py-3 bg-red-600 text-white rounded-lg mb-6 transition hover:bg-red-700">Vider le panier</button>
                    {cartItems.length > 0 ? (
                ...
                {/* Section Résumé */}
                {cartItems.length > 0 && (
                    <div className="sm:w-1/2 lg:block hidden bg-gray-700 bg-opacity-70 p-6 rounded-lg text-white text-sm sm:text-lg h-full flex flex-col shadow-lg">
                        ...
                        <div className="mt-6 sm:mt-8">
                            ...
                            <button className="mt-4 py-3 w-full bg-green-500 rounded-lg transition hover:bg-green-700">Passer à la caisse</button>
                        </div>
                    </div>
                )}
            </div>
